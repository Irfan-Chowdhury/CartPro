        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">
          ...
          <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-dollar"></i><span><?php echo e(__('file.Sales')); ?></span></a>
            <ul id="sale" class="collapse list-unstyled">
              <li id="sale-list-menu"><a href="#"><?php echo e(__('file.Orders')); ?></a></li>
          ...
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('flash_sale')): ?>
            <li><a href="<?php echo e(route('admin.flash_sale.index')); ?>"><i class="fa fa-bolt"></i><span><?php echo e(__('file.Flash Sales')); ?></span></a></li>
          <?php endif; ?>

          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('coupon')): ?>
            <li><a href="<?php echo e(route('admin.coupon.index')); ?>"><i class="fa fa-tags"></i><span><?php echo e(__('file.Coupons')); ?></span></a></li>
          <?php endif; ?>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page')): ?>
            <li><a href="<?php echo e(route('admin.page.index')); ?>"><i class="fa fa-file-text"></i><span><?php echo e(trans('file.Pages')); ?></span></a></li>
          <?php endif; ?>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('menu')): ?>
            <li><a href="<?php echo e(route('admin.menu')); ?>"><i class="dripicons-list"></i><span><?php echo e(trans('file.Menus')); ?></span></a></li>
          <?php endif; ?>

          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users_and_roles')): ?>
            <li><a href="#user" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-user-circle"></i><span><?php echo e(__('file.Users and Roles')); ?></span></a>
                <ul id="user" class="collapse list-unstyled">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user')): ?>
                    <li id="navigation-menu"><a href="<?php echo e(route('admin.user')); ?>"><?php echo e(__('file.Users')); ?></a></li>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role')): ?>
                    <li id="navigation-menu"><a href="<?php echo e(route('admin.role.index')); ?>"><?php echo e(__('file.Roles')); ?></a></li>
                <?php endif; ?>
                </ul>
            </li>
          <?php endif; ?>
            ...
            <li><a href="#localization" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-globe"></i><span><?php echo e(__('Localization')); ?></span></a>
                <ul id="localization" class="collapse list-unstyled">
                    ...
                    <li><a href="<?php echo e(route('languages.translations.index',Session::get('currentLocal'))); ?>"><?php echo e(__('Translations')); ?></a></li>
...
<!-- Sidebar-->
<?php /**PATH C:\xampp\htdocs\cartpro\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>