...
<section>
    ...
    <div class="container-fluid mb-3">
	    ...
	    <button type="button" class="btn btn-info" name="formModal" data-toggle="modal" data-target="#formModal">
	    	<i class="fa fa-plus"></i> <?php echo e(__('Add Attribute Set')); ?>
    	...
    	<table id="AtttributeSetTable" class="table ">
    	    <thead>
        	   <tr>
        		    ...
        		    <th scope="col"><?php echo e(trans('Attribute Set Name')); ?></th>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cartpro\resources\views/admin/pages/attribute_set/index.blade.php ENDPATH**/ ?>