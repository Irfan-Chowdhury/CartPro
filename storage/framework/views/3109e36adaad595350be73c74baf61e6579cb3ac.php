                        ...
                        <div class="col-sm-8">
                            <select name="storefront_top_brands[]" class="form-control selectpicker" multiple="multiple" data-live-search="true" data-live-search-style="begins" title='<?php echo e(__('Select Tag')); ?>'>
                                <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $__empty_1 = true; $__currentLoopData = $item->brandTranslation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php if($value->local==$locale): ?>
                                                <option value="<?php echo e($item->id); ?>"
                                                    <?php $__currentLoopData = $array_brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\cartpro\resources\views/admin/pages/storefront/home_page_section/top_brands.blade.php ENDPATH**/ ?>