    ...
    <div class="side-navbar-wrapper">
      ...
      <div class="main-menu">
        <ul id="side-main-menu" class="side-menu list-unstyled">
          ...
          <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-cube"></i><span><?php echo e(__('file.product')); ?></span></a>
...
<!-- Sidebar-->
<?php /**PATH C:\laragon\www\Running_File\cartpro\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>