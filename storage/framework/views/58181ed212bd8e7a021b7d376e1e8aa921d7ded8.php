...
<section>
    ...
    <div class="container-fluid mb-3">
        ...
        <?php if(auth()->user()->can('menu-store')): ?>
        ...
        <?php endif; ?>
        <?php if(auth()->user()->can('menu-action')): ?>
    ...
    $("#bulk_action").on("click",function(){
        ...
        if(idsArray.length === 0){
            ...
            $("#active").on("click",function(){
                ...
                action_type = "active";
                $.ajax({
                    url: "<?php echo e(route('admin.menu.bulk_action')); ?>",
                    method: "GET",
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cartpro_related\3_cartpro_menu\resources\views/admin/pages/menu/index.blade.php ENDPATH**/ ?>