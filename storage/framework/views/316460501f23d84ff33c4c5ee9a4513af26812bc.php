                ...
                <div class="col-md-6 mar-top-30">
                    ...
                    <div class="cart-subtotal">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="label"><?php echo e(__('file.Tax')); ?></div>
                            <div class="price">
                                <?php if(env('CURRENCY_FORMAT')=='suffix'): ?>
                                    <span class="tax_rate">0</span> <?php echo e(env('DEFAULT_CURRENCY_SYMBOL')); ?>

                                <?php else: ?>
                                    <?php echo e(env('DEFAULT_CURRENCY_SYMBOL')); ?> <span class="tax_rate">0</span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="payment-options">
                            ...
                            <label class="custom-checkbox">
                                ...
                                <span class="sm-heading"><?php echo e(__('file.Paypal')); ?></span>
                            ...
                            <label class="custom-checkbox">
                                ...
                                <span class="sm-heading"><?php echo e(__('file.Stripe')); ?></span>
                                <span class="card-options"><img src="<?php echo e(asset('public/frontend/images/others/stripe.png')); ?>" alt="..."></span>
                            </label>
                    ...
                    <div id="stripeContent">
                        <?php echo $__env->make('frontend.pages.payment_page.stripe_from', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>

                    <div class="checkout-actions mar-top-30" id="payNowPaypal">
                        <button class="button lg style1 d-block text-center w-100" id="orderBtn"><?php echo e(__('file.Pay Now')); ?></button>
                    </div>
                </div>
            </div>
        </div>
...
$(function(){
    ...
    $('#billing_country').change(function() {
        ...
        // console.log(total);
        $.ajax({
            url: "<?php echo e(route('cart.country_wise_tax')); ?>",
            type: "GET",
            data: {
        ...
        var card_expiry_year = $('.card-expiry-year').val();
            ...
            function stripeHandleResponse(status, response) {
                if (response.error) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('stripe.payment')); ?>",
                        method: "POST",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cartpro\resources\views/frontend/pages/checkout.blade.php ENDPATH**/ ?>