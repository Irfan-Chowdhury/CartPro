        ...
        <div class="container-fluid mb-3">
            <?php if(auth()->user()->can('category-store')): ?>
                <button type="button" class="btn btn-info parent_load" name="create_record" id="create_record">
                    <i class="fa fa-plus"></i> <?php echo e(__('Add Category')); ?>

                </button>
            <?php endif; ?>
            <?php if(auth()->user()->can('category-action')): ?>
                <button type="button" class="btn btn-danger" name="bulk_delete" id="bulk_action">
                    <i class="fa fa-minus-circle"></i> <?php echo app('translator')->get('Bulk Action'); ?>
                </button>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cartpro_language_test\cartpro\resources\views/admin/pages/category/index.blade.php ENDPATH**/ ?>