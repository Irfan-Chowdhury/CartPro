            ...
            <div class="modal-body">
                ...
                <form method="post" id="submitForm"  class="form-horizontal" action="<?php echo e(route('admin.brand.store')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label for="exampleFormControlFile1"><?php echo e(__('Brand Logo')); ?></label>
...
<?php /**PATH C:\laragon\www\cartpro\resources\views/admin/pages/brand/create.blade.php ENDPATH**/ ?>