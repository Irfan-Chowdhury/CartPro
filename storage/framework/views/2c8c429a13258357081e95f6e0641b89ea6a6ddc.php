    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('file.Edit Attribute Set')); ?></h5>&nbsp;&nbsp;&nbsp;&nbsp; <span id="error_message_edit"></span>
          ...
          <?php echo csrf_field(); ?>
            ...
            <span id="error_message_edit"></span>
              ...
              <div class="form-group">
                ...
                <input type="text" name="attribute_set_name" id="attributeSetNameEdit" required class="form-control" placeholder="<?php echo e(__('file.Attribute Set Name')); ?>">
...
<?php /**PATH /var/www/html/cartpro/cartproshop_new/resources/views/admin/pages/attribute_set/edit_modal.blade.php ENDPATH**/ ?>