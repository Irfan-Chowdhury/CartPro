    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><?php echo e($tr->translate('Add Category')); ?></h5>
                ...
                <form method="post" id="submitForm" action="<?php echo e(route('admin.category.store')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label><?php echo e($tr->translate('Category Name')); ?> *</label>
                            <input type="text" name="category_name" id="category_name" required class="form-control" placeholder="<?php echo e($tr->translate('Category Name')); ?>">
                        </div>

                        <div class="col-md-6 form-group">
                            <label><?php echo e($tr->translate('Description')); ?> *</label>
                            <input type="text" name="description" id="description" required class="form-control" placeholder="<?php echo e($tr->translate('Description Name')); ?>">
                        </div>

                        <div class="col-md-6 form-group">
                            <label><?php echo e($tr->translate('Parent Category')); ?> </label>
                        ...
                        <div class="col-md-6 form-group mb-3">
                            <label><?php echo e($tr->translate('Position')); ?> *</label>
                            <select class="form-control selectpicker" data-live-search="true" data-live-search-style="begins" title='<?php echo e(__('Select Position')); ?>' name="description_position" required="">
                                <option value="1"><?php echo e($tr->translate('Top')); ?></option>
                                <option value="0"><?php echo e($tr->translate('Bottom')); ?></option>
                            </select>
                        </div>

                        <div class="col-md-6 form-group mt-5">
                            <label for="exampleFormControlFile1"><?php echo e($tr->translate('Insert Image')); ?></label>
                        ...
                        <div class="col-md-6">
                                <div class="form-check mt-5">
                                    ...
                                    <label class="form-check-label"  for="exampleCheck1"><?php echo e($tr->translate('Featured')); ?></label>
                                </div>
                        </div>
                        ...
                        <div class="col-md-6 form-group">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="defaultCheck1"><?php echo e($tr->translate('Active')); ?></label>
                            </div>
                        </div>
...
<?php /**PATH C:\laragon\www\cartpro\resources\views/admin/pages/category/create.blade.php ENDPATH**/ ?>