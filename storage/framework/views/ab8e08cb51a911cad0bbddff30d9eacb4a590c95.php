...
<section>
    ...
    <div class="container-fluid mb-3">
        <h4 class="font-weight-bold mt-3"><?php echo e(__('This Year')); ?> - <?php echo e(date('Y')); ?></h4>
        <br>
    </div>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cartpro\resources\views/admin/pages/report/this_year.blade.php ENDPATH**/ ?>