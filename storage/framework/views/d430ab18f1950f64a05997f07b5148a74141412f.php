<form role="form" action="<?php echo e(route('stripe.payment')); ?>" method="post" class="validation" data-cc-on-file="false"
    data-stripe-publishable-key="<?php echo e(env('STRIPE_KEY')); ?>" id="payment-form" class="stripSubmitForm">
    <?php echo csrf_field(); ?>
        ...
        <div class="card-body">
            ...
            <div class="form-row row">
                <div class="checkout-actions mar-top-30">
                    <button class="button lg style1 d-block text-center w-100" type="submit" id="payStripeBtn"><?php echo e(__('file.Pay Now')); ?></button>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\cartpro\resources\views/frontend/pages/payment_page/stripe_from.blade.php ENDPATH**/ ?>