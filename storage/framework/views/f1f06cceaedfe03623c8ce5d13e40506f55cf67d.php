                        ...
                        <div class="col-md-6">
                            <form action="<?php echo e(route('product.add_to_cart')); ?>" class="addToCart" method="post">
                                ...
                                <div class="item-details">
                                    ...
                                    <h3 class="item-name"><?php echo e($item->orderProductTranslation->product_name ?? null); ?></h3>
                                    ...
                                    <div class="item-short-description">
                                        <p><?php echo e($item->orderProductTranslation->short_description ?? null); ?>.</p>
                                    </div>
                                    <hr>
                                    <?php
                                        $attribute = [];
...
<?php /**PATH /var/www/html/cartpro/cartproshop_new/resources/views/frontend/includes/quickshop_trending.blade.php ENDPATH**/ ?>