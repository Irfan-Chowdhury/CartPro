          ...
          <?php echo csrf_field(); ?>
            ...
            <div class="container-fluid"><span id="error_message"></span></div>
              ...
              <div class="form-group">
                ...
                <input type="text" name="attribute_set_name" id="attributeSetName" required class="form-control" placeholder="<?php echo e(__('file.Attribute Set Name')); ?>">
...
<?php /**PATH /var/www/html/cartpro/cartproshop_new/resources/views/admin/pages/attribute_set/create_modal.blade.php ENDPATH**/ ?>