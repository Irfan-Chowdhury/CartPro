                        ...
                        <div class="col-md-6">
                            <div class="slider-wrapper">
                                <div class="slider-for-modal">
                                    <?php $__currentLoopData = $product_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($value->product_id==$item->id): ?>
                        ...
                        <div class="col-md-6">
                            <form action="<?php echo e(route('product.add_to_cart')); ?>" class="addToCart" method="post">
                                ...
                                <div class="item-details">
                                    ...
                                    <h3 class="item-name"><?php echo e($item->product_name); ?></h3>
                                    <div class="d-flex justify-content-between">
                                        <div class="item-brand"><?php echo app('translator')->get('file.Brand'); ?>: <a href=""><?php echo e($item->brand_name); ?></a></div>
                                        <div class="item-review">
                                            ...
                                            <span>( <?php echo e(round($item->avg_rating)); ?> )</span>
                                        </div>
                                        <?php if($item->sku): ?>
                                    ...
                                    <hr>
                                    <?php $__currentLoopData = $product_attr_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $productAttrVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($item->id == $productAttrVal->id): ?>
                                            <?php
                                                $attribute = [];
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $attribute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <div class="item-variant">
                                                    ...
                                                    <input type="hidden" name="attribute_name[]" class="attribute_name" value="<?php echo e($value); ?>">
                                                        ...
                                                        <?php $__empty_2 = true; $__currentLoopData = $productAttrVal->productAttributeValues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                    ...
                                    <div class="item-options">
                                        ...
                                        <?php endif; ?>
                                        <div class="button button-icon style4 sm <?php if(auth()->guard()->check()): ?> add_to_wishlist <?php else: ?> forbidden_wishlist <?php endif; ?>" data-product_id="<?php echo e($item->id); ?>" data-product_slug="<?php echo e($item->slug); ?>" data-category_id="<?php echo e($category_ids[$item->id]->category_id); ?>" data-qty="1"><span><i class="ti-heart"></i> <span><?php echo app('translator')->get('file.Add to Wishlist'); ?></span></span></div>
                                    </div>
...
<?php /**PATH /var/www/html/cartpro/cartproshop_new/resources/views/frontend/includes/quickshop_shop.blade.php ENDPATH**/ ?>