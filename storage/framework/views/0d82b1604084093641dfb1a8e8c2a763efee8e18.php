...
<div class="modal fade" id="createModalForm" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" class="col-md-8 form-control" name="menu_name" id="menuName" placeholder="Type Menu Name">
                        </div>
  ...
  </div><?php /**PATH C:\laragon\www\cartpro\resources\views/admin/pages/menu/create.blade.php ENDPATH**/ ?>