<div class="js-cookie-consent cookie-consent fixed-bottom p-2 text-center">
    ...
    <span class="cookie-consent__message">
        <?php echo htmlspecialchars_decode(trans('cookieConsent::texts.message')); ?>
...
<?php /**PATH /var/www/html/cartpro/cartproshop_new/resources/views/vendor/cookieConsent/dialogContents.blade.php ENDPATH**/ ?>