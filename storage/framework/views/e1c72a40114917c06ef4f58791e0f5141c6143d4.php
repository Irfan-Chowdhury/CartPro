    ...
    <header>
        <?php if(!Cookie::has('top_banner') && env('TOPBAR_BANNER_ENABLED')): ?>
            <div id="top_banner" class="text-center" style="background-color:#e5e8ec">
                <img src="<?php echo e(asset($topbarLogoPath)); ?>" alt="">
                    ...
                    <div class="d-lg-flex d-xl-flex justify-content-between">
                        <div class="header-top-left d-none d-lg-flex d-xl-flex">
                            <ul class="header-top-social menu">
                                <?php if(isset($storefrontFacebookLink)): ?>
                                <li><a href="<?php echo e($storefrontFacebookLink); ?>"><i class="ti-facebook"></i></a></li>
                                <?php endif; ?>
                                <?php if(isset($storefrontTwitterLink)): ?>
                                <li><a href="<?php echo e($storefrontTwitterLink); ?>"><i class="ti-instagram"></i></a></li>
                                <?php endif; ?>
                                <?php if(isset($storefrontInstagramLink)): ?>
                                <li><a href="<?php echo e($storefrontInstagramLink); ?>"><i class="ti-twitter"></i></a></li>
                                <?php endif; ?>
                                <?php if(isset($storefrontYoutubeLink)): ?>
                        ...
                        <div class="header-top-right">
                            <ul>
                                ...
                                <li class="has-dropdown"><a href="#"><i class="las la-language"></i>&nbsp; <?php echo e($languages[$locale]->language_name); ?></a>
                                    <ul class="dropdown p-0">
                                        <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><a href="<?php echo e(route('cartpro.default_language_change',$item->id)); ?>" <?php echo e($item->local==Session::get('currentLocale') ? 'selected': ''); ?>><?php echo e($item->language_name); ?></a></li>
                                ...
                                <li class="has-dropdown"><a href="#"><i class="las la-money-bill"></i>&nbsp; <?php if(Session::has('currency_code')): ?> <?php echo e(Session::get('currency_code')); ?> <?php else: ?> <?php echo e(env('DEFAULT_CURRENCY_CODE')); ?> <?php endif; ?></a>
                                    <ul class="dropdown p-0">
                                        <?php $__currentLoopData = $currencyCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-lg-3 col-7">
                            ...
                            <div class="logo">
                                <a href="<?php echo e(route('cartpro.home')); ?>">
                                    <img src="<?php echo e($headerLogoPath); ?>" alt="Brand logo">
                                </a>
                            </div>
                        </div>
                            ...
                            <ul class="offset-menu-wrapper p-0">
                                ...
                                <?php if(auth()->guard()->check()): ?>
                                    <li class="wishlist__menu d-none d-lg-inline-block d-xl-inline-block">
                                        ...
                                        <span class="badge badge-light wishlist_count"><?php echo e($totalWishlist); ?></span>
                                    </li>
                                <?php else: ?>
                                ...
                                <li class="cart__menu">
                                    ...
                                    <span class="badge badge-light cart_count"><?php echo e($cartCount); ?></span>
                                    <span class="total">
                                        <?php if(env('CURRENCY_FORMAT')=='suffix'): ?>
                                            <span class="cart_total"><?php echo e(number_format((float)$cartTotal * $changeCurrencyRate, env('FORMAT_NUMBER'), '.', '')); ?></span> <?php echo $__env->make('frontend.includes.SHOW_CURRENCY_SYMBOL', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php else: ?>
                                            <?php echo $__env->make('frontend.includes.SHOW_CURRENCY_SYMBOL', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <span class="cart_total"><?php echo e(number_format((float)$cartTotal * $changeCurrencyRate, env('FORMAT_NUMBER'), '.', '')); ?></span>
                                        <?php endif; ?>
                                    </span>
                                </li>
                            </ul>
                                    ...
                                    <ul id="cat_menu" class="dropdown p-0">
                                        <?php $__empty_1 = true; $__currentLoopData = $categories->where('parent_id',NULL); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <?php if($category->child->isNotEmpty()): ?>
                                                ...
                                                <li class="has-dropdown"><a href="<?php echo e(route('cartpro.category_wise_products',$category->slug)); ?>"><i class="<?php echo e($category->icon ?? null); ?>"></i> <?php echo e($category->translation->category_name); ?> (<?php echo e($category_product_count[$category->id]); ?>)</a>
                                                    <ul class="dropdown">
                                                        <?php $__currentLoopData = $category->child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <li><a href="<?php echo e(route('cartpro.category_wise_products',$item->slug)); ?>"><i class="<?php echo e($item->icon ?? null); ?>"></i><?php echo e($item->translation->category_name); ?> (<?php echo e($category_product_count[$item->id]); ?>) </a></li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </li>
                                            <?php else: ?>
                                                
                                                <li><a href="<?php echo e(route('cartpro.category_wise_products',$category->slug)); ?>"><i class="<?php echo e($category->icon ?? null); ?>"></i><?php echo e($category->translation->category_name); ?> (<?php echo e($category_product_count[$category->id]); ?>)</a></li>
                                            <?php endif; ?>
        ...
        <div class="shopping__cart">
            ...
            <div class="shopping__cart__inner">
                <div class="shp__cart__wrap">
                        <div class="cart_list">
                            <?php $__empty_1 = true; $__currentLoopData = $cartContents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div id="<?php echo e($item->rowId); ?>" class="shp__single__product">
                                    ...
                                    <div class="shp__pro__details">
                                        ...
                                        <span class="my_cart_specific_qty_<?php echo e($item->rowId); ?>"><?php echo e($item->qty); ?></span> x <span class="shp__price">
                                            <?php if(env('CURRENCY_FORMAT')=='suffix'): ?>
                                                <span><?php echo e(number_format((float)$item->price * $changeCurrencyRate, env('FORMAT_NUMBER'), '.', '')); ?></span> <?php echo $__env->make('frontend.includes.SHOW_CURRENCY_SYMBOL', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            <?php else: ?>
                                                <span><?php echo $__env->make('frontend.includes.SHOW_CURRENCY_SYMBOL', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php echo e(number_format((float)$item->price * $changeCurrencyRate, env('FORMAT_NUMBER'), '.', '')); ?></span>
                                            <?php endif; ?>
                                        </span>
                                    </div>
            ...
            <div class="shopping__cart__footer">
                <div class="shoping__total">
                    ...
                    <span class="total__price">
                        <?php if(env('CURRENCY_FORMAT')=='suffix'): ?>
                            <span><?php echo e(number_format((float)$cartTotal * $changeCurrencyRate, env('FORMAT_NUMBER'), '.', '')); ?></span> <?php echo $__env->make('frontend.includes.SHOW_CURRENCY_SYMBOL', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php else: ?>
                            <?php echo $__env->make('frontend.includes.SHOW_CURRENCY_SYMBOL', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <span class="total_price"><?php echo e(number_format((float)$cartTotal * $changeCurrencyRate, env('FORMAT_NUMBER'), '.', '')); ?></span>
                        <?php endif; ?>
                    </span>
                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/cartpro/cartproshop_new/resources/views/frontend/includes/header.blade.php ENDPATH**/ ?>