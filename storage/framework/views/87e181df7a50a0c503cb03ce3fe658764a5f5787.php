...
unset($__errorArgs, $__bag); ?>" id="inputEmail3" <?php if(isset($product->productTranslation[0]->product_name)): ?> value="<?php echo e($product->productTranslation[0]->product_name); ?>" <?php else: ?> placeholder="Type Product Name" <?php endif; ?>>
                                                                <input type="hidden" name="product_translation_id" class="form-control" id="inputEmail3" <?php if(isset($product->productTranslation[0]->id)): ?> value="<?php echo e($product->productTranslation[0]->id); ?>" <?php endif; ?>>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <textarea name="description" id="description" class="form-control text-editor">
                                                                    <?php if(isset($product->productTranslation[0]->product_name)): ?> <?php echo e($product->productTranslation[0]->description); ?> <?php endif; ?>
                                                                </textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" name="price" id="price" class="form-control" id="inputEmail3" value="<?php echo e($product->price); ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" name="special_price" id="specialPrice" class="form-control" id="inputEmail3" value="<?php echo e($product->special_price); ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <textarea name="short_description" id="short_description" class="form-control" rows="5">
                                                                    <?php if(isset($product->productTranslation[0]->short_description)): ?> <?php echo e($product->productTranslation[0]->short_description); ?> <?php endif; ?>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\cartpro\resources\views/admin/pages/product/edit.blade.php ENDPATH**/ ?>