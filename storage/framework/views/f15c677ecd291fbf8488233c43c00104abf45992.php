...
<div class="modal fade" id="formModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('Add Attribute Set')); ?></h5>
          ...
          <?php echo csrf_field(); ?>
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label><?php echo e(__('Attribute Set Name')); ?></label>
  ...
  </div><?php /**PATH C:\laragon\www\cartpro\resources\views/admin/pages/attribute_set/create.blade.php ENDPATH**/ ?>