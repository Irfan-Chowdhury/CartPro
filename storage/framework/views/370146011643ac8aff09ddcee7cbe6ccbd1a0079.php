...
<section>
    ...
    <div class="container-fluid mb-3">
        <h4 class="font-weight-bold mt-3"><?php echo e(__('This Month')); ?> - <?php echo e(date('F')); ?></h4>
        <br>
    </div>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cartpro\resources\views/admin/pages/report/this_month.blade.php ENDPATH**/ ?>