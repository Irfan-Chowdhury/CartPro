                                            ...
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($item->childs->count()>0): ?>
                                                    <li class="nav-item dropdown">
                                                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><?php echo e($item->item_name); ?></a>
                                                        <div class="dropdown-menu">
                                                            <?php $__currentLoopData = $item->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subMenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if($item->type=='category'): ?>
                                                                    <li><a href="#" <?php if($subMenu->target=='new_tab'): ?> target="_blank" <?php endif; ?> ><?php echo e($subMenu->item_name); ?></a></li>
                                                                <?php elseif($subMenu->type=='page'): ?>
                                                                    <li><a href="<?php echo e(route('page.slug',$subMenu->page->meta_title)); ?>" <?php if($subMenu->target=='new_tab'): ?> target="_blank" <?php endif; ?> ><?php echo e($subMenu->item_name); ?></a></li>
                                                                <?php elseif($subMenu->type=='url'): ?>
                                                                    <a class="dropdown-item" href="<?php echo e($subMenu->url); ?>" <?php if($subMenu->target=='new_tab'): ?> target="_blank" <?php endif; ?>><?php echo e($subMenu->item_name); ?></a>
                                                                <?php endif; ?>
                                                ...
                                                <?php else: ?> 
                                                    <?php if($item->type=='category'): ?>
                                                        <li><a href="#" <?php if($item->target=='new_tab'): ?> target="_blank" <?php endif; ?> ><?php echo e($item->item_name); ?></a></li>
                                                    <?php elseif($item->type=='page'): ?>
                                                        <li><a href="<?php echo e(route('page.slug',$item->page->meta_title)); ?>" <?php if($item->target=='new_tab'): ?> target="_blank" <?php endif; ?> ><?php echo e($item->item_name); ?></a></li>
                                                    <?php elseif($item->type=='url'): ?>
                                                        <li><a href="<?php echo e($item->url); ?>" <?php if($item->target=='new_tab'): ?> target="_blank" <?php endif; ?>><?php echo e($item->item_name); ?></a></li>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
...
</html><?php /**PATH C:\laragon\www\cartpro\resources\views/layouts/app.blade.php ENDPATH**/ ?>