                                                                ...
                                                                <?php $__currentLoopData = $item->attributeSetTranslation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php if($key<1): ?>
                                                                        <?php if($value->local==$local): ?>
                                                                            <option value="<?php echo e($item->id); ?>" <?php if($item->id==$attribute->attribute_set_id): ?> selected <?php endif; ?>><?php echo e($value->attribute_set_name); ?></option>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cartpro_related\2_cartpro_lang\resources\views/admin/pages/attribute/edit.blade.php ENDPATH**/ ?>