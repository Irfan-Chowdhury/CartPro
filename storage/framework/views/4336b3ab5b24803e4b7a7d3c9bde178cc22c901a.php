...
<section>
    ...
    <div class="container-fluid mb-3 ml-3">
        ...
        <h4 class="mb-3 ml-4"> Shipping Report </h4>
            ...
            <div class="row">
                <div class="col-md-8">
                    <table id="datatable1" class="table">
                        <thead>
                            <tr>
                                <th class="wd-15p">Shipping Method</th>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(route('admin.reports.shipping_report')); ?>" method="get">
                                ...
                                <div class="form-group mt-4">
                                    <h5 class="mt-4 card-subtitle mb-2 text-muted">Shipping Method</h5>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cartpro\resources\views/admin/pages/report/shipping_report.blade.php ENDPATH**/ ?>