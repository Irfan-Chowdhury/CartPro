...
<section>
    <div class="container-fluid mb-3">
        ...
        <h4 class="font-weight-bold mt-3"><?php echo e(__('Pages')); ?></h4>
        <div id="alert_message" role="alert"></div>
        <br>

        <?php if(auth()->user()->can('page-store')): ?>
        ...
        <?php if(auth()->user()->can('page-action')): ?>
    	...
    	<table id="dataListTable" class="table ">
    	    <thead>
        	   <tr>
        		    ...
        		    <th scope="col"><?php echo e(trans('Page Name')); ?></th>
        		    <th scope="col"><?php echo e(trans('file.Status')); ?></th>
        		    <th scope="col"><?php echo e(__('URL Link')); ?></th>
...
<?php echo $__env->make('admin.pages.page.create_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('admin.pages.page.edit_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        let table = $('#dataListTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('admin.page.index')); ?>",
            },
            columns: [
                {
                    data: null,
    ...
    $('#submitForm').on('submit', function (e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo e(route('admin.page.store')); ?>",
            method: "POST",
    ...
    $(document).on('click', '.edit', function () {
        ...
        $.ajax({
            url: "<?php echo e(route('admin.page.edit')); ?>",
            type: "GET",
            data: {page_id:rowId},
            success: function (data) {
                ...
                tinymce.get('body_edit').setContent(data.page_translation.body);
    ...
    $('#updateForm').on('submit', function (e) {
        ...
        $.ajax({
            url: "<?php echo e(route('admin.page.update')); ?>",
            method: "POST",
    ...
    $(document).on("click",".active",function(e){
        ...
        $.ajax({
            url: "<?php echo e(route('admin.page.active')); ?>",
            type: "GET",
            data: {id:id},
            success: function(data){
                console.log(data);
    ...
    $(document).on("click",".inactive",function(e){
        ...
        $.ajax({
            url: "<?php echo e(route('admin.page.inactive')); ?>",
            type: "GET",
            data: {id:id},
            success: function(data){
                console.log(data);
    ...
    $("#bulk_action").on("click",function(){
        ...
        if(idsArray.length === 0){
            ...
            $("#active").on("click",function(){
                ...
                action_type = "active";
                $.ajax({
                    url: "<?php echo e(route('admin.page.bulk_action')); ?>",
                    method: "GET",
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\cartpro\resources\views/admin/pages/page/index.blade.php ENDPATH**/ ?>