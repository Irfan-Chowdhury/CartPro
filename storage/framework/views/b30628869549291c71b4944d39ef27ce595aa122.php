<?php $__env->startSection('meta_info'); ?>
    ...
    <meta product="og:site_name" <?php if(isset($setting_home_page_seo->meta_site_name)): ?> content="<?php echo e($setting_home_page_seo->meta_site_name); ?>" <?php endif; ?> >
    <meta product="og:title"  <?php if(isset($setting_home_page_seo->meta_title)): ?> content="<?php echo e($setting_home_page_seo->meta_title); ?>" <?php endif; ?> >
    <meta product="og:description" <?php if(isset($setting_home_page_seo->meta_description)): ?> content="<?php echo e($setting_home_page_seo->meta_description); ?>" <?php endif; ?> >
    <meta product="og:url" <?php if(isset($setting_home_page_seo->meta_url)): ?> content="<?php echo e($setting_home_page_seo->meta_url); ?>" <?php endif; ?> >
    <meta product="og:type" <?php if(isset($setting_home_page_seo->meta_type)): ?> content="<?php echo e($setting_home_page_seo->meta_type); ?>" <?php endif; ?> >
    <?php if(isset($setting_home_page_seo->meta_image)): ?>
        <meta product="og:image" content="<?php echo e(asset($setting_home_page_seo->meta_image)); ?>">
    <?php endif; ?>
                            ...
                            <div class="product-grid-item">
                                <div class="single-product-wrapper">
                                    <div class="single-product-item">
                                        ...
                                        <?php if(isset($item->product->baseImage->image) && Illuminate\Support\Facades\File::exists(public_path($item->product->baseImage->image_medium))): ?>
                                            <img class="lazy" data-src="<?php echo e(asset($item->product->baseImage->image_medium)); ?>">
                                        <?php else: ?>
...
<!-- One Coloumn Banner --->
<?php if($one_column_banner_enabled==1): ?>
<section>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <a href="<?php echo e($settings_new['storefront_one_column_banner_call_to_action_url']->plain_value); ?>" target="<?php echo e($settings_new['storefront_one_column_banner_open_in_new_window']->plain_value==1 ? '__blank' : ''); ?>"><img class="lazy" data-src="<?php echo e(asset($one_column_banner_image)); ?>" alt=""></a>
            </div>
        </div>
    </div>
</section>
...
<!--Brands-->
<?php if($storefront_top_brands_section_enabled==1): ?>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/cartproshop/resources/views/frontend/pages/home.blade.php ENDPATH**/ ?>