                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(route('admin.reports.product_purchase_report')); ?>" method="get">
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cartpro\resources\views/admin/reports/product_purchase_report.blade.php ENDPATH**/ ?>