...
<head>
    ...
    <!-- Dripicons icon font-->
    <link rel="preload" href="<?php echo e(asset('vendor/dripicons/webfont.css')); ?>" as="style"
    ...
    <link rel="stylesheet"
        href="<?php echo e(asset('admin-lte')); ?>/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="<?php echo e(asset('admin-lte')); ?>/plugins/summernote/summernote-bs4.min.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <?php echo $__env->make('lte.admin.layout.partials.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <!-- Main Sidebar Container -->
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="index3.html" class="brand-link">
                <img src="<?php echo e(asset('admin-lte')); ?>/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <?php echo $__env->make('lte.admin.layout.partials.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <?php echo $__env->make('lte.admin.layout.partials.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /var/www/html/cartpro/cartproshop_new/resources/views/lte/admin/layout/master.blade.php ENDPATH**/ ?>