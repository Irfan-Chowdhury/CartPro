        ...
        <?php if(count($translations)): ?>
            <div class="table-responsive">
                <table id="language-table" class="table ">
                    ...
                    <thead>
                    <tr>
                        <th class="w-1/5 uppercase"><?php echo e(__('translation::translation.key')); ?></th>

                        <th class="w-2/5 uppercase"><?php echo e(config('app.locale')); ?></th>
                        <th class="w-2/5 uppercase"><?php echo e($language); ?></th>
                    </tr>
                    </thead>
                    <tbody>
...
<?php echo $__env->make('translation::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cartpro\resources\views/vendor/translation/languages/translations/index.blade.php ENDPATH**/ ?>