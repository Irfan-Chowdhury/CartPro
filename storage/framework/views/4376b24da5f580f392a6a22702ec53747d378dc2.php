    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" id="submitForm" action="<?php echo e(route('admin.tax.store')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            ...
                            <select name="country" class="col-md-8 form-control selectpicker" data-live-search="true" title='<?php echo e(__('Select Conutry')); ?>'>
...
<?php /**PATH C:\xampp\htdocs\cartpro\resources\views/admin/pages/tax/create_modal.blade.php ENDPATH**/ ?>