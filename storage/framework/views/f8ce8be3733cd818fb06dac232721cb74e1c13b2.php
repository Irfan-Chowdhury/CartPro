                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $top_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <?php endif; ?>
                                                <td><?php echo e($item->category->catTranslation->category_name ?? $item->category->categoryTranslationDefaultEnglish->category_name ?? null); ?></td>
                                                <td>
                                                    <?php if(env('CURRENCY_FORMAT')=='suffix'): ?>
                                                        <?php echo e(number_format($item->total_amount,'2')); ?>  <?php echo e(env('DEFAULT_CURRENCY_SYMBOL')); ?>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/cartpro/cartproshop_new/resources/views/admin/pages/home.blade.php ENDPATH**/ ?>