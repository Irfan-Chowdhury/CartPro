    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalTitle"><?php echo e(__('file.Edit Color')); ?></h5> &nbsp;&nbsp;&nbsp;&nbsp; <span id="error_message"></span>
...
<?php /**PATH C:\laragon\www\cartpro\resources\views/admin/pages/color/edit_modal.blade.php ENDPATH**/ ?>