...
<?php $__env->startSection('frontend_content'); ?>
            ...
            <div class="banner-slider">
                <?php $__empty_1 = true; $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="item">
                        <?php if($item->slider_image !== null && Illuminate\Support\Facades\File::exists(public_path($item->slider_image))): ?>
                            <div class="img-fill"
                                style="background-image: url(<?php echo e(asset($item->slider_image)); ?>); background-size: cover; background-position: center;">
                        <?php else: ?>
                            <div class="img-fill"
                                style="background-image: url('https://dummyimage.com/1269x300/e5e8ec/e5e8ec&text=Slider'); background-size: cover; background-position: center;">
                        <?php endif; ?>
    ...
    <div class="col-md-4">
        <?php $__currentLoopData = $sliderBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($item->image): ?>
                <a href="<?php echo e($item->action_url); ?>" target="<?php echo e($item->new_window == 1 ? '__blank' : ''); ?>">
                    <div class="slider-banner"
                        style="background-image:url(<?php echo e($item->image); ?>);background-size:cover;background-position: center;">
                        <h4 class="text-dark"><?php echo e($item->title); ?></h4>
                    </div>
                </a>
            <?php else: ?>
    ...
    <?php if($threeColumnBannerFull->isThreeColumnBannerFullEnabled): ?>
        <section>
            <div class="container">
                <div class="row">
                    <?php $__currentLoopData = $threeColumnBannerFull->banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-sm-4">
    ...
    <!--Product area starts-->
    <?php if(isset($productDetailsTab->isSectionEnabled)): ?>
                                                            ...
                                                            <div class="single-product-wrapper">
                                                                <div class="single-product-item">
                                                                    <?php if(isset($item->mediumImage)): ?>
                                                                        <a href="<?php echo e(url('product/'.$item->slug.'/'. $category->categoryId)); ?>"><img class="swiper-lazy" data-src="<?php echo e($item->mediumImage); ?>"></a>
                                                                    <?php else: ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="section-title mb-3">
                        <h3>
                            <?php echo e($flashSaleData->storefrontFlashSaleTitle); ?>
                    ...
                    <div class="deals-slider-wrapper swiper-container mb-3">
                        <div class="swiper-wrapper">
                            ...
                            <?php if(isset($flashSaleData->flashSaleWithProducts->products)): ?>
                                <?php $__currentLoopData = $flashSaleData->flashSaleWithProducts->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="swiper-slide">
                                        <form action="<?php echo e(route('product.add_to_cart')); ?>" class="addToCart" method="post">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="product_id" value="<?php echo e($product->id); ?>">
                                            <input type="hidden" name="product_slug" value="<?php echo e($product->slug); ?>">
                                            <input type="hidden" name="category_id" value="<?php echo e($product->category->id); ?>">
                                            <input type="hidden" name="flash_sale" value="1">
                                            <input type="hidden" name="flash_sale_price" value="<?php echo e($product->price); ?>">
                                            <input type="hidden" name="qty" value="1">

                                            <div class="single-product-wrapper deals">
                                                <div class="single-product-item">
                                                    <a href="<?php echo e(url('product/'.$product->slug.'/'. $product->category->id)); ?>"><img class="swiper-lazy" data-src="<?php echo e($product->mediumImage); ?>"></a>
                                                    <!-- product-promo-text -->
                                                    <?php echo $__env->make('frontend.includes.product-promo-text',['manage_stock'=>$product->manageStock, 'qty'=>$product->qty, 'in_stock'=>$product->inStock, 'current_date'=>date('Y-m-d') ,'new_to'=> $product->newTo], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    <!--/ product-promo-text -->

                                                    <div class="product-overlay">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#id_<?php echo e($product->id); ?>"> <span class="ti-zoom-in" data-bs-toggle="tooltip" data-bs-placement="top" title="quick view"></span></a>
                                                        <a>
                                                            <span class="ti-heart add_to_wishlist" data-product_id="<?php echo e($product->id); ?>" data-product_slug="<?php echo e($product->slug); ?>" data-category_id="<?php echo e($product->category->id); ?>" data-qty="1" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app('translator')->get('file.Add to wishlist'); ?>"></span>
                                                        </a>

                                                    </div>
                                                </div>
                                                <div class="product-details">
                                                    <a class="product-name text-center" href="<?php echo e(url('product/'.$product->slug.'/'. $product->category->id)); ?>">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div>
                                                            ...
                                                            <div class="product-price">
                                                                <?php if($product->specialPrice >0 && $product->specialPrice < $product->price): ?>
                                                                    <span class="promo-price">
                                                                        <?php if(env('CURRENCY_FORMAT')=='suffix'): ?>
                                                                            <?php echo e(number_format((float)$product->specialPrice  * $changeCurrencyRate, env('FORMAT_NUMBER'), '.', '')); ?> <?php echo $__env->make('frontend.includes.SHOW_CURRENCY_SYMBOL', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                        <?php else: ?>
                                                                            <?php echo $__env->make('frontend.includes.SHOW_CURRENCY_SYMBOL', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php echo e(number_format((float)$product->specialPrice  * $changeCurrencyRate, env('FORMAT_NUMBER'), '.', '')); ?>

                                                                        <?php endif; ?>
                                                                    </span>
                                                                    <span class="old-price">
                                                                        <?php if(env('CURRENCY_FORMAT')=='suffix'): ?>
                                                                            <?php echo e(number_format((float)$product->price * $changeCurrencyRate, env('FORMAT_NUMBER'), '.', '')); ?> <?php echo $__env->make('frontend.includes.SHOW_CURRENCY_SYMBOL', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                        <?php else: ?>
                                                                            <?php echo $__env->make('frontend.includes.SHOW_CURRENCY_SYMBOL', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php echo e(number_format((float)$product->price * $changeCurrencyRate, env('FORMAT_NUMBER'), '.', '')); ?>
                                                        ...
                                                        <div>
                                                            <?php if(($product->manageStock==1 && $product->qty==0) || ($product->inStock==0)): ?>
                                                                <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip" data-bs-placement="top" title="Disabled"><button class="btn button style2 sm" disabled><i class="las la-cart-plus"></i></button></span>
                                                            <?php else: ?>
                                                                <button class="button style2 sm" type="submit" data-bs-toggle="tooltip" data-bs-placement="top"><i class="las la-cart-plus"></i></button>
                                                            <?php endif; ?>
                                                    ...
                                                    <div class="daily-deals-wrap">
                                                        <!-- countdown start -->
                                                        <div class="countdown-deals text-center" data-countdown="<?php echo e($product->end_date); ?>">
                                                            <div class="cdown day">
                                                    ...
                                                    <?php if($product->qty>=0): ?>
                                                        <?php echo app('translator')->get('file.Available'); ?> <?php echo e($product->qty); ?>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <?php $__currentLoopData = $vertical->catgoryWiseProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-4">
                                <div class="section-title mb-3">
                                    <h3><?php echo e($category->verticalProductTitle); ?></h3>
                                    <!-- Add Pagination -->
                                    <div class="list-navigation">
                                        <div class="list-button-prev list-slider-<?php echo e($key+1); ?>-arrow-prev"><i class="ti-angle-left"></i></div>
                                        <div class="list-button-next list-slider-<?php echo e($key+1); ?>-arrow-next"><i class="ti-angle-right"></i></div>
                                    </div>
                                </div>
                                <div class="list-slider-wrapper-<?php echo e($key+1); ?> swiper-container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <form action="<?php echo e(route('product.add_to_cart')); ?>" class="addToCart" method="post">
                                                    ...
                                                    <div class="single-product-wrapper list">
                                                        <div class="single-product-item">
                                                            <a href="<?php echo e(url('product/'.$product->slug.'/'. $category->id)); ?>"><img class="swiper-lazy" data-src="<?php echo e($product->smallImage); ?>"></a>
                                                        </div>
                                                        <div class="product-details">
                                                            <a class="product-name" href="<?php echo e(url('product/'.$product->slug.'/'. $category->id)); ?>">
                                                                <?php echo e($product->name); ?>
                                ...
                                <div class="product-grid-item">
                                    <div class="single-product-wrapper">
                                        <div class="single-product-item">
                                            ...
                                            <?php if(isset($item->mediumImage)): ?>
                                                <img class="lazy" data-src="<?php echo e($item->mediumImage); ?>">
                                            <?php else: ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <form action="<?php echo e(route('product.add_to_cart')); ?>" class="addToCart" method="post">
                                        ...
                                        <div class="item-details">
                                            <a class="item-category" href=""><?php echo e(isset($category->categoryName) ? $category->categoryName : null); ?></a>
                                            <h3 class="item-name"><?php echo e($item->name); ?></h3>
                                            <div class="d-flex justify-content-between">
                                                <div class="item-brand"><?php echo app('translator')->get('file.Brand'); ?>: <a href=""><?php echo e(isset($item->brand->name) ? $item->brand->name : ''); ?></a></div>
                                                <div class="item-review">
