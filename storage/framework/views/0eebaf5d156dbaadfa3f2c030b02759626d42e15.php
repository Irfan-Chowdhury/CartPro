...
?>
    ...
    <div class="modal fade quickshop" id="id_<?php echo e($item->product->id); ?>" tabindex="-1" role="dialog" aria-labelledby="flash_sale_<?php echo e($item->product->slug ?? null); ?>" aria-hidden="true">
                        ...
                        <div class="col-md-6">
                            <form action="<?php echo e(route('product.add_to_cart')); ?>" class="addToCart" method="post">
                                ...
                                <div class="item-details">
                                    <a class="item-category" href=""><?php echo e($item->product->categoryProduct[0]->categoryTranslation->category_name ?? null); ?></a>
                                    ...
                                    <div class="item-options">
                                        ...
                                        <?php if(($item->product->manage_stock==1 && $item->product->qty==0) || ($item->product->in_stock==0)): ?>
                                            ...
                                            <a>
                                                <button class="button button-icon style4 sm" data-product_id="<?php echo e($item->product->id); ?>" data-product_slug="<?php echo e($item->product->slug); ?>" data-category_id="<?php echo e($item->product->categoryProduct[0]->category_id ?? null); ?>" data-qty="1"><span><i class="ti-heart"></i> <span>Add to wishlist</span></span></button>
                                            </a>
                                        <?php else: ?>
                                            <button type="submit" class="button button-icon style1"><span><i class="las la-shopping-cart"></i> <span>Add to cart</span></span></button>
                                            <a>
                                                <div class="button button-icon style4 sm add_to_wishlist" data-product_id="<?php echo e($item->product->id); ?>" data-product_slug="<?php echo e($item->product->slug); ?>" data-category_id="<?php echo e($item->product->categoryProduct[0]->category_id ?? null); ?>" data-qty="1"><span><i class="ti-heart"></i> <span>Add to wishlist</span></span></div>
                                            </a>
                                        <?php endif; ?>
...
<?php /**PATH /var/www/html/cartproshop/resources/views/frontend/includes/quickshop_flash_sale.blade.php ENDPATH**/ ?>