            ...
            <div class="col-8">
              <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" aria-labelledby="slider_banner_home_page_section" id="slider_banner">
                        <?php echo $__env->make('admin.pages.storefront.home_page_section.slider_banner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    ...
                    <div class="tab-pane fade" aria-labelledby="one_column_banner-home_page_section" id="one_column_banner">
                        <?php echo $__env->make('admin.pages.storefront.home_page_section.one_column_banner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    ...
                    <div class="tab-pane fade" aria-labelledby="two_column_banners-home_page_section" id="two_column_banners">
                        <?php echo $__env->make('admin.pages.storefront.home_page_section.two_column_banners', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    ...
                    <div class="tab-pane fade" aria-labelledby="three_column_banners-home_page_section" id="three_column_banners">
                        <?php echo $__env->make('admin.pages.storefront.home_page_section.three_column_banners', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    ...
                    <div class="tab-pane fade" aria-labelledby="three_column_full_width_banners-home_page_section" id="three_column_full_width_banners">
                        <?php echo $__env->make('admin.pages.storefront.home_page_section.three_column_full_width_banners', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    ...
                    <div class="tab-pane fade" aria-labelledby="featured_categories-home_page_section" id="featured_categories">
                        <?php echo $__env->make('admin.pages.storefront.home_page_section.featured_categories', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>

                     <!-- Top Brands -->
                    <!-- DB_ROW_ID-[80-81] => setting[79-80] -->
                    <div class="tab-pane fade" aria-labelledby="top_brands-home_page_section" id="top_brands">
                        <?php echo $__env->make('admin.pages.storefront.home_page_section.top_brands', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    ...
                    <div class="tab-pane fade" aria-labelledby="product_tabs_one-home_page_section" id="product_tabs_one">
                        <?php echo $__env->make('admin.pages.storefront.home_page_section.product_tabs_one', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    ...
                    <div class="tab-pane fade" aria-labelledby="product_tabs_two-home_page_section" id="product_tabs_two">
                        <?php echo $__env->make('admin.pages.storefront.home_page_section.product_tabs_two', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
...
<script type="text/javascript">
    ...
    $('#sliderBannerSubmit').on('submit', function (e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo e(route('admin.storefront.slider_banners.store')); ?>",
            method: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
    ...
    $('#oneColumnBannerSubmit').on('submit', function (e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo e(route('admin.storefront.one_column_banner.store')); ?>",
            method: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
    ...
    $('#twoColumnBannersSubmit').on('submit', function (e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo e(route('admin.storefront.two_column_banners.store')); ?>",
            method: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
    ...
    $('#threeColumnBannersSubmit').on('submit', function (e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo e(route('admin.storefront.three_column_banners.store')); ?>",
            method: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
    ...
    $('#threeColumnFullWidthBannersSubmit').on('submit', function (e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo e(route('admin.storefront.three_column_full_width_banners.store')); ?>",
            method: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
    ...
    $('#topBrandsSubmit').on('submit', function (e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo e(route('admin.storefront.top_brands.store')); ?>",
            method: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
    ...
    $('#productTabsOneSubmit').on('submit', function (e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo e(route('admin.storefront.product_tab_one.store')); ?>",
            method: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
    ...
    $('#productTabsTwoSubmit').on('submit', function (e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo e(route('admin.storefront.product_tab_two.store')); ?>",
            method: "POST",
            data: new FormData(this),
            contentType: false,
            cache: false,
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cartpro\resources\views/admin/pages/storefront/index.blade.php ENDPATH**/ ?>