                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="number" min="0" name="value" class="form-control" value="<?php echo e($coupon->value); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="number" min="0" name="minimum_spend" class="form-control" <?php if($coupon->minimum_spend): ?> value="<?php echo e($coupon->minimum_spend); ?>" <?php endif; ?> placeholder="Type Minimum Spend" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label"><b><?php echo e(trans('file.Maximum Spend')); ?></b></label>
                                                        <div class="col-sm-9">
                                                            <input type="number" min="0" name="maximum_spend" class="form-control" <?php if($coupon->maximum_spend): ?> value="<?php echo e($coupon->maximum_spend); ?>" <?php endif; ?> placeholder="Type Maximum Spend" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cartpro\resources\views/admin/pages/coupon/edit.blade.php ENDPATH**/ ?>