    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('Edit Category')); ?></h5> &nbsp;&nbsp;&nbsp;&nbsp; <span id="error_message_edit"></span>
...
<?php /**PATH C:\laragon\www\cartpro\resources\views/admin/pages/category/edit_modal.blade.php ENDPATH**/ ?>