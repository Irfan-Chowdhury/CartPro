...
<section>
    ...
    <div class="container-fluid mb-3">
        <h4 class="font-weight-bold mt-3"><?php echo app('translator')->get('file.Attributes Create'); ?></h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-4 col-form-label"><b><?php echo app('translator')->get('Attribute Set'); ?> <span class="text-danger">*</span></b></label>
                                                        <div class="col-sm-8">
...
unset($__errorArgs, $__bag); ?>" data-live-search="true" data-live-search-style="begins" title='<?php echo e(__('file.Select Attribute Set')); ?>'>
                                                                <?php $__empty_1 = true; $__currentLoopData = $attributeSets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                    <option value="<?php echo e($item->id); ?>"><?php echo e($item->attributeSetTranslation->attribute_set_name ?? $item->attributeSetTranslationEnglish->attribute_set_name ?? null); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <button type="submit" class="btn btn-success"><?php echo e(__('file.Submit')); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="values" role="tabpanel" aria-labelledby="attribute-values">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="variants">
                                                <div class="row">
                                                    <div class="col-6 form-group">
                                                        <label><?php echo e(__('file.Value Name')); ?></label>
                                            ...
                                            <span class="btn btn-link add-more" id="addMore"><i class="dripicons-plus"></i> <?php echo app('translator')->get('Add More'); ?></span>
                                            <br><br>
                                            <div class="d-flex justify-content-center">
                                                <button type="submit" class="btn btn-success"><?php echo e(__('file.Submit')); ?></button>
                                            </div>
...
<?php echo $__env->make('admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cartpro\resources\views/admin/pages/attribute/create.blade.php ENDPATH**/ ?>