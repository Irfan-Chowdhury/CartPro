    ...
    <header>
        <?php if(!Cookie::has('top_banner') && env('TOPBAR_BANNER_ENABLED')): ?>
            <div id="top_banner" class="text-center" style="background-color:#e5e8ec">
                <img src="<?php echo e($topbarLogoPath); ?>" alt="">
                                    ...
                                    <ul id="cat_menu" class="dropdown p-0">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <?php if($category->childs): ?>
                                                <li class="has-dropdown"><a href="<?php echo e(route('cartpro.category_wise_products',$category->slug)); ?>"><i class="<?php echo e($category->icon ?? null); ?>"></i> <?php echo e($category->categoryName); ?> (<?php echo e($category->totalProducts); ?>) </a>
                                                    <ul class="dropdown">
                                                        <?php $__currentLoopData = $category->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li><a href="<?php echo e(route('cartpro.category_wise_products',$child->slug)); ?>"><i class="<?php echo e($child->icon ?? null); ?>"></i><?php echo e($child->childCategoryName); ?> (<?php echo e($child->totalProducts); ?>) </a></li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </li>
                                            <?php else: ?>
                                                <li><a href="<?php echo e(route('cartpro.category_wise_products',$category->slug)); ?>"><i class="<?php echo e($category->icon ?? null); ?>"></i><?php echo e($category->categoryName); ?> (<?php echo e($category->totalProducts); ?>)</a></li>
                                            <?php endif; ?>
