...
$url = 'https://demo.lion-coders.com/soft/cartproshopverify/';
...
<body>
    <div class="col-md-6 offset-md-3">
        <div class='wrapper'>
            <header>
                <img src="assets/images/cartpro-logo.png" alt="Logo"/>
                <h1 class="text-center">CartPro Auto Installer</h1>
            </header>
            <hr>
