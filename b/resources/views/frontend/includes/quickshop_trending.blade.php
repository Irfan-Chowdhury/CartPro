                                ...
                                <div class="item-details">
                                    ...
                                    <div class="item-options">
                                        ...
                                        @if (($item->product->manage_stock==1 && $item->product->qty==0) || ($item->product->in_stock==0))
                                            ...
                                            <a>
                                                <div class="button button-icon style4 sm" data-product_id="{{$item->product_id}}" data-product_slug="{{$item->product->slug}}" data-category_id="{{$item->product->categoryProduct[0]->category_id ?? null}}" data-qty="1"><p>Add To Wishlist</p></div>
                                            </a>
                                        @else
                                            <button type="submit" class="button button-icon style1"><span><i class="las la-shopping-cart"></i> <span>Add to cart</span></span></button>
                                            <a>
                                                <div class="button button-icon style4 sm add_to_wishlist" data-product_id="{{$item->product_id}}" data-product_slug="{{$item->product->slug}}" data-category_id="{{$item->product->categoryProduct[0]->category_id ?? null}}" data-qty="1"><p>Add To Wishlist</p></div>
                                            </a>
                                        @endif
                                    </div>
