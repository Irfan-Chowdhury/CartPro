                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="attribute_set_id" id="attributeSetId" class="form-control selectpicker @error('attribute_set_id') is-invalid @enderror" data-live-search="true" data-live-search-style="begins" title='@lang('file.Select Attribute Set')'>
                                                        @forelse ($attributeSets as $attributeSet)
                                                            ...
                                                            <option value="{{$attributeSet->id}}" @if($attributeSet->id==$attribute->attribute_set_id) selected @endif>{{$attributeSet->name}}</option>
                                                        @empty
                                                        @endforelse
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input type="text" name="attribute_name" id="navbarText" class="form-control @error('attribute_name') is-invalid @enderror" id="inputEmail3" value="{{$attribute->name}}">
                                            ...
                                            @foreach ($attribute->attributeValues as $key => $value)
                                                <div class="row">
                                                    <div class="col-6 form-group">
                                                        ...
                                                        <input type="text" name="value_name[]" required class="form-control" value="{{$value->name}}">
                                                        <input type="hidden" name="attribute_value_id[]" required class="form-control" value="{{$value->id}}">
                                                    </div>
                                                    <div class="col-2">
