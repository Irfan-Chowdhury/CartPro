                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-check mt-1">
                                <input type="checkbox" @if($setting->storefront_two_column_banner_enabled->plain_value==1) checked @endif value="1" name="storefront_two_column_banner_enabled" class="form-check-input">
                    ...
                    <div class="row">
                            ...
                            @forelse ($storefront_images as $key=> $item)
                                @if ($item->title=='two_column_banner_image_1')
                                    @if($item->image!==null && Illuminate\Support\Facades\File::exists(public_path($item->image)))
                                        <img src="{{asset($item->image)}}" id="storefrontTwoColumnBannerImage1" height="100px" width="100px">
                                    @else
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="storefront_two_column_banners_1_call_to_action_url" placeholder="@lang('file.Type URL')" class="form-control"
                                value="{{$setting->storefront_two_column_banners_1_call_to_action_url->plain_value}}">
                            <br><br>
                            <input type="checkbox" class="m-1" @if($setting->storefront_two_column_banners_1_open_in_new_window->plain_value==1) checked @endif value="1" name="storefront_two_column_banners_1_open_in_new_window">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            @forelse ($storefront_images as $key=> $item)
                                @if ($item->title=='two_column_banner_image_2')
                                    @if($item->image!==null && Illuminate\Support\Facades\File::exists(public_path($item->image)))
                                        <img src="{{asset($item->image)}}" id="storefrontTwoColumnBannerImage2" height="100px" width="100px">
                                    @else
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="storefront_two_column_banners_2_call_to_action_url" placeholder="@lang('file.Type URL')" class="form-control"
                                value="{{$setting->storefront_two_column_banners_2_call_to_action_url->plain_value}}">
                            <br><br>
                            <input type="checkbox" class="m-1" @if($setting->storefront_two_column_banners_2_open_in_new_window->plain_value==1) checked @endif value="1" name="storefront_two_column_banners_2_open_in_new_window">
                            <label for="inputEmail3" class="ml-2 p-0 col-form-label"><b>{{__('file.Open in new window')}}</b></label>
                        </div>
                    </div>
