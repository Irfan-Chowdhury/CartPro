                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-check mt-1">
                                <input type="checkbox" @if($setting->storefront_top_categories_section_enabled->plain_value==1) checked @endif value="1" name="storefront_top_categories_section_enabled" class="form-check-input">
