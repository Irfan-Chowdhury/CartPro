...
class PublicCommonData
{
    ...
    private function homeSection($settings, $changeCurrencyRate, $storefrontImages)
    {
        ...
        // StoreFront
        $oneColumnBannerImage = file_exists($storefrontImages['one_column_banner_image']->image) ? asset($storefrontImages['one_column_banner_image']->image) :  'https://dummyimage.com/1200x270/12787d/ffffff&text=CartPro';
    ...
    private function masterSection($storefrontImages, $changeCurrencyRate, $settingStore)
    {
        ...
        $faviconLogoPath = file_exists($storefrontImages['favicon_logo']->image) ? asset($storefrontImages['favicon_logo']->image) :  'https://dummyimage.com/221.6x221.6/12787d/ffffff&text=CartPro';
    ...
    private function headerSection($setting, $storefrontImages, $changeCurrencyRate)
    {
        ...
        //StoreFront
        $topbarLogoPath = file_exists($storefrontImages['topbar_logo']->image) ? asset($storefrontImages['topbar_logo']->image) :  'https://dummyimage.com/1170x60/12787d/ffffff&text=CartPro';
        $headerLogoPath = file_exists($storefrontImages['header_logo']->image) ? asset($storefrontImages['header_logo']->image) :  'https://dummyimage.com/1170x60/12787d/ffffff&text=CartPro';
    ...
    private function footerSection($locale, $setting, $storefrontImages, $settingStore)
    {
        ...
        $footerTagIds = json_decode($setting->storefront_footer_tag_id->plain_value);
         ...
         //StoreFront
         $paymentMethodImage = file_exists($storefrontImages['accepted_payment_method_image']->image) ? asset($storefrontImages['accepted_payment_method_image']->image) :  'https://dummyimage.com/180x40/12787d/ffffff&text=CartPro';
