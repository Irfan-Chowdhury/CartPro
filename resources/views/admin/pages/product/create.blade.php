                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" name="sku" id="sku" class="form-control" id="inputEmail3" placeholder="Type SKU" >
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="inputEmail3" class="col-sm-4 col-form-label"><b> {{__('Multiple Images')}} </b></label>
                                                            <div class="col-sm-8">
                                                                <input type="file" name="multiple_images[]" multiple id="multipleImages" class="form-control @error('multiple_images') is-invalid @enderror">
