            ...
            <div class="col-md-10">
                <form id="stripSubmit">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-check mt-1">
                                <input type="checkbox" value="1" name="publishable_key" @isset($setting_strip->publishable_key) {{$setting_strip->publishable_key=="1" ? 'checked':''}} @endisset class="form-check-input">
