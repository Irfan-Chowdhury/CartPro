    ...
    <script>
        $(document).ready(function() {
            ...
            $(".collapse.show").each(function() {
                $(this).prev(".card-header").find(".fa").addClass("fa-angle-down").removeClass(
                    "fa-angle-right");
            });

            // Toggle right and down arrow icon on show hide of collapse element
            $(".collapse").on('show.bs.collapse', function() {
                $(this).prev(".card-header").find(".fa").removeClass("fa-angle-right").addClass(
                    "fa-angle-down");
            }).on('hide.bs.collapse', function() {
                $(this).prev(".card-header").find(".fa").removeClass("fa-angle-down").addClass(
                    "fa-angle-right");
            });
        });
    </script>
        ...
        <div class="row">
                ...
                <div id="accordion">
                    ...
                    <div class="card mb-0">
                        <div class="card-header" id="generalSettings">
                            <div class="btn" data-toggle="collapse" data-target="#collapse1" aria-expanded="true"
                                aria-controls="collapseOne">
                                <h5 class="text-bold"><i class="fa fa-angle-right"></i>@lang('file.General Settings')</h5>
                            </div>
                        </div>
                        <div id="collapse1" class="collapse show" aria-labelledby="generalSettings"
                            data-parent="#accordion">
                            <div class="card-body">
                                <div class="list-group" id="list-tab" role="tablist">
                                    <a class="list-group-item list-group-item-action active" id="general-settings"
                                        data-toggle="list" href="#general" role="tab"
                                        aria-controls="home">@lang('file.General')</a>
                                    <a class="list-group-item list-group-item-action" id="home-page-seo-settings"
                                        data-toggle="list" href="#home-page-seo" role="tab"
                                        aria-controls="home">@lang('file.Home Page SEO')</a>
                                    <a class="list-group-item list-group-item-action" id="store-settings" data-toggle="list"
                                        href="#store" role="tab" aria-controls="social">@lang('file.Store-Contact')</a>
                                    <a class="list-group-item list-group-item-action" id="about-us-settings"
                                        data-toggle="list" href="#about-us" role="tab"
                                        aria-controls="social">@lang('file.About Us')</a>
                                    <a class="list-group-item list-group-item-action" id="currency-settings"
                                        data-toggle="list" href="#currency" role="tab"
                                        aria-controls="settings">@lang('file.Currency')</a>
                                    <a class="list-group-item list-group-item-action" id="mail-settings" data-toggle="list"
                                        href="#mail" role="tab" aria-controls="mail">@lang('file.Mail')</a>
                                    <a class="list-group-item list-group-item-action" id="newsletter-settings"
                                        data-toggle="list" href="#newsletter" role="tab"
                                        aria-controls="newsletter">@lang('file.Newsletter')</a>
                                    <a class="list-group-item list-group-item-action" id="emptyDatabase-settings"
                                        data-toggle="list" href="#emptyDatabase" role="tab"
                                        aria-controls="emptyDatabase">@lang('file.Empty Database')</a>
                                    <a class="list-group-item list-group-item-action" id="backup-settings"
                                        data-toggle="list" href="#backup" role="tab"
                                        aria-controls="backup">@lang('file.System Backup')</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-0">
                        <div class="card-header" id="socialLogin">
                            <div class="btn" data-toggle="collapse" data-target="#collapse2" aria-expanded="true"
                                aria-controls="collapseOne">
                        ...
                        <div id="collapse2" class="collapse" aria-labelledby="socialLogin" data-parent="#accordion">
                            <div class="card-body">
                                <div class="list-group" id="list-tab" role="tablist">
                                    <a class="list-group-item list-group-item-action" id="facebook-social_login"
                                        data-toggle="list" href="#facebook" role="tab"
                                        aria-controls="facebook">@lang('file.Facebook')</a>
                                    <a class="list-group-item list-group-item-action" id="google-social_login"
                                        data-toggle="list" href="#google" role="tab"
                                        aria-controls="google">@lang('file.Google')</a>
                                    <a class="list-group-item list-group-item-action" id="github-social_login"
                                        data-toggle="list" href="#github" role="tab"
                                        aria-controls="github">@lang('file.Github')</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-0">
                        <div class="card-header" id="shippingMethod">
                            <div class="btn" data-toggle="collapse" data-target="#collapse3" aria-expanded="true"
                                aria-controls="collapseOne">
                        ...
                        <div id="collapse3" class="collapse" aria-labelledby="shippingMethod" data-parent="#accordion">
                            <div class="card-body">
                                <div class="list-group" id="list-tab" role="tablist">
                                    <a class="list-group-item list-group-item-action" id="free_shipping-shipping_methods"
                                        data-toggle="list" href="#free_shipping" role="tab"
                                        aria-controls="free_shipping">@lang('file.Free Shipping')</a>
                                    <a class="list-group-item list-group-item-action" id="local_pickup-shipping_methods"
                                        data-toggle="list" href="#local_pickup" role="tab"
                                        aria-controls="local_pickup">@lang('file.Local Pickup')</a>
                                    <a class="list-group-item list-group-item-action" id="flat_rate-shipping_methods"
                                        data-toggle="list" href="#flat_rate" role="tab"
                                        aria-controls="flat_rate">@lang('file.Flat Rate')</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header" id="paymentMethod">
                            <div class="btn" data-toggle="collapse" data-target="#collapse4" aria-expanded="true"
                        ...
                        <div id="collapse4" class="collapse" aria-labelledby="paymentMethod" data-parent="#accordion">
                            <div class="card-body">
                                <div class="list-group" id="list-tab" role="tablist">
                                    <a class="list-group-item list-group-item-action" id="paypal-payment_methods"
                                        data-toggle="list" href="#paypal" role="tab"
                                        aria-controls="paypal">@lang('file.Paypal')</a>
                                    <a class="list-group-item list-group-item-action" id="strip-payment_methods"
                                        data-toggle="list" href="#strip" role="tab"
                                        aria-controls="strip">@lang('file.Strip')</a>
                                    <a class="list-group-item list-group-item-action" id="sslcommerz-payment_methods"
                                        data-toggle="list" href="#sslcommerz" role="tab"
                                        aria-controls="sslcommerz">@lang('file.SSL Commerz')</a>
                                    <a class="list-group-item list-group-item-action"
                                        id="cash_on_delivery-payment_methods" data-toggle="list" href="#cash_on_delivery"
                                        role="tab" aria-controls="cash_on_delivery">@lang('file.Cash On Delivery')</a>
                                    <a class="list-group-item list-group-item-action" id="razorpay-payment_methods"
                                        data-toggle="list" href="#razorpay" role="tab"
                                        aria-controls="razorpay">@lang('file.Razorpay')</a>
                                    <a class="list-group-item list-group-item-action" id="paystack-payment_methods"
                                        data-toggle="list" href="#paystack" role="tab"
                                        aria-controls="paystack">@lang('file.Paystack')</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-8">
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <!-- home-page-seo -->
                    <div class="tab-pane fade show" id="home-page-seo" role="tabpanel"
                        aria-labelledby="home-page-seo-settings">
                    ...
                    <!-- Custom CSS/Js -->
                    <div class="tab-pane fade" id="customCssJss" role="tabpanel"
                        aria-labelledby="custom_css_jss-settings">
                        @include('admin.pages.setting.general_setting.custom_css_jss')
                    </div>

                    <!-- Empty Database-->
                    <div class="tab-pane fade" id="emptyDatabase" role="tabpanel"
                        aria-labelledby="emptyDatabase-settings">
                    ...
                    <!-- Free Shipping -->
                    <div class="tab-pane fade" id="free_shipping" role="tabpanel"
                        aria-labelledby="free_shipping-shipping_methods">
                        @include('admin.pages.setting.shipping_method.free_shipping')
                    </div>

                    <!-- Local Pickup -->
                    <div class="tab-pane fade" id="local_pickup" role="tabpanel"
                        aria-labelledby="local_pickup-shipping_methods">
                        @include('admin.pages.setting.shipping_method.local_pickup')
                    </div>

                    <!-- Flat Rate -->
                    <div class="tab-pane fade" id="flat_rate" role="tabpanel"
                        aria-labelledby="flat_rate-shipping_methods">
                    ...
                    <div class="tab-pane fade" id="sslcommerz" role="tabpanel"
                        aria-labelledby="sslcommerz-payment_methods">
    ...
    <script type="text/javascript">
        (function($) {
            ...
            $('#generalSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.general.store_or_update',
                ])
            });
            ...
            $('#homePageSeoSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.home_page_seo.store_or_update',
                ])
            });
            ...
            $('#storeSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.store.store_or_update',
                ])
            });
            ...
            $('#exchangeRateService').change(function() {
                ...
                if (exchangeRateService == "fixer") {
                    data =
                        '<label class="col-sm-4 col-form-label"><b> {{ __('Fixer Access Key') }} &nbsp;<span class="text-danger">*</span> </b></label>';
                    ...
                    data =
                        '<label class="col-sm-4 col-form-label"><b> {{ __('Forge API Key') }} &nbsp;<span class="text-danger">*</span> </b></label>';
                    data += '<div class="col-sm-8">';
                    ...
                    data =
                        '<label class="col-sm-4 col-form-label"><b> {{ __('Currency Data Feed API Key') }} &nbsp;<span class="text-danger">*</span> </b></label>';
                    data += '<div class="col-sm-8">';
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.errors) {
                            ...
                            $('#alert_message').fadeIn("slow"); //Check in top in this blade
                            $('#alert_message').addClass('alert alert-danger').html(data
                                .selectionError);
                            setTimeout(function() {
                                $('#alert_message').fadeOut("slow");
                            }, 3000);
            ...
            $('#smsService').change(function() {
                ...
                if (smsService == "vonage") {
                    data1 =
                        '<label class="col-sm-4 col-form-label"><b> {{ __('API Key') }} &nbsp;<span class="text-danger">*</span> </b></label>';
                    ...
                    data2 =
                        '<label class="col-sm-4 col-form-label"><b> {{ __('API Secret') }} &nbsp;<span class="text-danger">*</span> </b></label>';
                    ...
                    data3 =
                        '<label class="col-sm-4 col-form-label"><b> {{ __('Account SID') }} &nbsp;<span class="text-danger">*</span> </b></label>';
                    ...
                    data4 =
                        '<label class="col-sm-4 col-form-label"><b> {{ __('Auth Token') }} &nbsp;<span class="text-danger">*</span> </b></label>';
            ...
            $('#mailSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.mail.store_or_update',
                ])
            });
            ...
            $('#newletterSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.newsletter.store_or_update',
                ])
            });
            ...
            $('#facebookSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.facebook.store_or_update',
                ])
            });
            ...
            $('#googleSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.google.store_or_update',
                ])
            });
            ...
            $('#githubSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.github.store_or_update',
                ])
            });
            ...
            $('#freeShippingSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.free_shipping.store_or_update',
                ])
            });
            ...
            $('#localPickupSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.local_pickup.store_or_update',
                ])
            });
            ...
            $('#flatRateSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.flat_rate.store_or_update',
                ])
            });
            ...
            $('#paypalSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.paypal.store_or_update',
                ])
            });
            ...
            $('#stripSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.strip.store_or_update',
                ])
            });
            ...
            $('#sslComerzSubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.sslcommerz.store_or_update',
                ])
            });
            ...
            $('#cashOnDeliverySubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.cash_on_delivery.store_or_update',
                ])
            });
            ...
            $('#razorpaySubmit').on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.razorpay.store_or_update',
                ])
            });
            ...
            $("#paystackSubmit").on('submit', function(e) {
                @include('admin.includes.common_js.setting_submit_js', [
                    'route_name' => 'admin.setting.paystack.store_or_update',
                ])
            });
