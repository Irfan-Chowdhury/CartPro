<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-10">
                {{-- <form id="generalSubmit" method="POST" action="{{route('admin.setting.general.store_or_update')}}"> --}}
                <form id="generalSubmit" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-check mt-1">
                                <input type="checkbox" value="1" @empty(!$setting_general) {{$setting_general->auto_approve_reviews =="1" ? "checked" : ''}} @endempty name="auto_approve_reviews" id="autoApproveReviews" class="form-check-input">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="form-check mt-1">
                                <input type="checkbox" value="1" @empty(!$setting_general) {{$setting_general->cookie_bar =="1" ? "checked" : ''}} @endempty name="cookie_bar" id="cookieBar" class="form-check-input">
