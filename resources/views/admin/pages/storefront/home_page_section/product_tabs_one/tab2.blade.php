...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <input type="text" name="storefront_product_tabs_1_section_tab_2_title" class="form-control"
            placeholder="@lang('file.Title')" value="{!! htmlspecialchars_decode($setting->storefront_product_tabs_1_section_tab_2_title->value) !!}">
    </div>
</div>
...
<div class="form-group row d-none">
    ...
    <div class="col-sm-8">
        <select name="storefront_product_tabs_1_section_tab_2_product_type"
            id="storefrontProductTabs_1_SectionTab_2_ProductType" class="form-control"
...
@if ($setting->storefront_product_tabs_1_section_tab_2_product_type->plain_value == 'category_products')
    <div class="form-group row" id="categoryFeild_2">
        <label class="col-sm-4 col-form-label"><b>@lang('file.Category')</b></label>
        <div class="col-sm-8">
            <select name="storefront_product_tabs_1_section_tab_2_category_id"
                id="storefrontProductTabs_1_SectionTab_2_CategoryId"
                class="form-control selectpicker" data-live-search="true"
                data-live-search-style="begins" title='{{ __('Select Category') }}'>
                @foreach ($categories as $item)
                    <option value="{{ $item->id }}"
                        {{ $setting->storefront_product_tabs_1_section_tab_2_category_id->plain_value == $item->id ? 'selected="selected"' : '' }}>
...
<div class="form-group row" id="productTabsField1">
    @if (
        !isset($setting->storefront_product_tabs_1_section_tab_2_product_type->plain_value) &&
            $setting->storefront_product_tabs_1_section_tab_2_product_type->plain_value == 'custom_products')
        <label class="col-sm-4 col-form-label"><b> {{ __('file.Products') }}</b></label>
        <div class="col-sm-8">
            <input type="text" name="storefront_product_tabs_1_section_tab_2_products"
                value="{{ $setting->storefront_product_tabs_1_section_tab_2_products->plain_value }}"
                class="form-control">
        </div>
    @elseif(
        !isset($setting->storefront_product_tabs_1_section_tab_2_product_type->plain_value) &&
            ($setting->storefront_product_tabs_1_section_tab_2_product_type->plain_value == 'latest_products' ||
                $setting->storefront_product_tabs_1_section_tab_2_product_type->plain_value == 'recently_viewed_products'))
        <label class="col-sm-4 col-form-label"><b> {{ __('file.Products Limit') }}</b></label>
        <div class="col-sm-8">
            <input type="text" name="storefront_product_tabs_1_section_tab_2_products_limit"
                value="{{ $setting->storefront_product_tabs_1_section_tab_2_products_limit->plain_value }}"
                class="form-control">
        </div>
    @endif
</div>
