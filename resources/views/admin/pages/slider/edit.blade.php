                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            ...
                            <select name="text_alignment" id="textAlignment" class="col-md-8 form-control selectpicker" data-live-search="true" data-live-search-style="begins" title='{{__('Select Target')}}'>
