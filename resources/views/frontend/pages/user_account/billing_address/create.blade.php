...
<div class="row">
    <div class="col-md-6">
        <button type="button" class="btn btn-primary  mb-5" data-bs-toggle="modal" data-bs-target="#createBillingAddress">@lang('file.Create')</button>
    </div>
</div>


<!-- Vertically centered modal -->
<div class="modal fade" id="createBillingAddress" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{route('billing_addrees.store')}}" method="post">
                @csrf
