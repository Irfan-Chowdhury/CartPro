<div class="col-md-12 tabs style2 mb-5">
    <ul class="nav nav-tabs mar-top-30 product-details-tab" role="tablist">
        <li class="nav-item">
            <a class="nav-link {{Request::routeIs('user_account') ? 'active' : ''  }}" href="{{route('user_account')}}">Dashboard</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{Request::routeIs('user.order.history') ? 'active' : ''  }}" href="{{route('user.order.history')}}">Orders</a>
        </li>
        <li class="nav-item">
