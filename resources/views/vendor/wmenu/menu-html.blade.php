...
<div id="hwpwrap" class="container-fluid">
                                            ...
                                            <div class="menu-edit ">
												<div id="nav-menu-header">
													<div class="major-publishing-actions">
														<label class="menu-name-label howto open-label" for="menu-name"> <span>Name</span>
															<input name="menu-name" id="menu-name" type="text" class="menu-name regular-text menu-item-textbox" title="Enter menu name" value="@if(isset($menuTranslation)){{$menuTranslation->menu_name}}@endif">
															<input type="hidden" id="idmenu" value="@if(isset($menuId)){{$menuId}}@endif" />
												...
												<div id="post-body">
													<div id="post-body-content">
														...
														@if(request()->has("menu"))
														<h3>@lang('file.Menu Structure')</h3>
														<div class="drag-instructions post-body-plain" style="">
															<p>
																@lang('file.Place each item in the order you prefer. Click on the arrow to the right of the item to display more configuration options')
															</p>
														</div>
														@endif
