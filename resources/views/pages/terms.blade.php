...
@section('content')
    ...
    <section class="">
        <div class="container">
            <p>Welcome to ctggrocer.com. Before assessing the terms & conditions please note that terms & conditions might change anytime. Therefore, please check the terms & conditions every time you place an order.</p>
            ...
            <ul>
                ...
                <li>Technical error in pricing information might take place due to system malfunction. In such a situation, CTG Grocer has the authority to cancel the order. We apologize for any inconvenience that may occur.</li>
            </ul>
            ...
            <ul>
                ...
                <li>For any return/exchange, customer needs to inform CTG Grocer Customer Care by calling:  01810061001 or email at: info@ctggrocer.com</li>
            </ul>
            ...
            <p>CTG Grocer tries its best to serve the customers. But if under any circumstances, we fail to fulfill our commitment or to provide the service, we will notify the customer within 24 hours via phone/ text/ email. If the service that CTG Grocer fails to complete, requires any refund, it will be done maximum within 10 to 12 Days after our acknowledgement.
            ...
            <p>The website might display inaccurate information regarding product price, availability, pictures, size & color at times due to technical malfunctions. CTG Grocer reserves the authority to correct & update those information from time to time.</p>
