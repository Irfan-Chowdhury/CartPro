...
<section class="header_text sub">
				...
				<h4><span>{{__('Subcategories')}}</span></h4>
			</section>
			...
			<section class="main-content">
				...
				<div class="row">						
						...
						<ul class="thumbnails listing-products">
							<li class="span3">
								<div class="product-box">
									...
									<a href="product_detail.html"><img alt="" style="width: 30px;height: 30px;" src="{{URL::to($rows->image)}}"></a><br/>
									
									<a href="{{url('subcategory/'.$rows->id)}}" class="title">{{$rows->category_name}}</a><br/>
								</div>
							</li>       
						</ul>
					@endforeach									
					...
					<div class="span3 col">
						{{-- @include('pages.product&category') --}}
						<div class="block">
							<h4 class="title">
