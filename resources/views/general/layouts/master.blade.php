...
<head>
    ...
    <!-- Plugins CSS -->
    <link href="{{asset('public/general/css/plugins.css')}}" rel="stylesheet" />
    <link href="{{asset('public/general/css/bootstrap-select.min.css')}}" rel="stylesheet" />
    <!-- style CSS -->
    <link href="{{asset('public/general/css/cartPro-style.css')}}" rel="stylesheet" />
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="logo">
                            <a href="#">
                                <img src="{{asset('public/general/images/logo-black.png')}}" alt="Brand logo">
                            </a>
                        </div>
                    </div>
                                        ...
                                        <li class="has-dropdown"><a href="laptops">Laptops</a>
                                            <ul class="megamenu dropdown">
                                                ...
                                                <li class="mega-banner">
                                                    <a href="shop-fullwidth.html"><img src="{{asset('public/general/images/others/menu-banner.jpg')}}')}}" alt="..."></a>
                                                </li>
                                            </ul>
                                        </li>
                ...
                <div class="shp__cart__wrap">
                    <div class="shp__single__product">
                        <div class="shp__pro__thumb">
                            <a href="#">
                                <img src="{{asset('public/general/images/promo/cart-1-300x350.jpg')}}" alt="product images">
                            </a>
                        </div>
                    ...
                    <div class="shp__single__product">
                        <div class="shp__pro__thumb">
                            <a href="#">
                                <img src="{{asset('public/general/images/promo/cart-2-300x350.jpg')}}" alt="product images">
                            </a>
                        </div>
                        <div class="shp__pro__details">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div id="hero-slider" class="carousel slide banner-tab-slider" data-interval="false" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active single-carousel-item" style="background-image: url('{{asset('public/general/images/header/header-61-900x530.jpg')}}')">
                                    <div class="carousel-content middle-v t-right">
                                        <h3>Bruno Magli<br>Shoes</h3>
                                        <a href="#" class="link-hov style1">Discover More</a>
                                    </div>
                                </div>
                                <div class="carousel-item single-carousel-item" style="background-image: url('{{asset('public/general/images/header/header-55-900x530.jpg')}}')">
                                    <div class="carousel-content middle-v t-right">
                                        <h3>Fendi<br>Cotton Tshirt</h3>
                                        <a href="#" class="link-hov style1">Discover More</a>
                                    </div>
                                </div>
                                <div class="carousel-item single-carousel-item" style="background-image: url('{{asset('public/general/images/header/header-52-900x530.jpg')}}')">
                                    <div class="carousel-content middle-v t-right">
                    ...
                    <div class="col-md-4">
                        <div class="cat-img style3 mar-bot-30">
                            <img src="{{asset('public/general/images/category/cat-20-560x320.jpg')}}" alt="...">
                        ...
                        <div class="cat-img style3">
                            <img src="{{asset('public/general/images/category/cat-6-560x320.jpg')}}" alt="...">
                    ...
                    <div class="product-slider-wrapper v1 swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="single-product-wrapper style2">
                                    <div class="single-product-item">
                                        <img src="{{asset('public/general/images/products/product-11.jpg')}}" alt="...">
                            ...
                            <div class="swiper-slide">
                                <div class="single-product-wrapper style4">
                                    <div class="single-product-item v1">
                                        <img class="product-img" src="{{asset('public/general/images/products/product-13.jpg')}}" alt="...">
                                        <img class="product-img-hover" src="{{asset('public/general/images/products/product-14.jpg')}}" alt="...">
                                ...
                                <div class="single-product-wrapper style3">
                                    <div class="single-product-item">
                                        <div class="product-item-img">
                                            <img src="{{asset('public/general/images/products/product-12.jpg')}}" alt="...">
                                        </div>
                                        <div class="product-overlay">
                                            <a href="#" data-toggle="modal" data-target="#exampleModal"> <span class="ti-zoom-in" data-toggle="tooltip" data-placement="right" title="quick view"></span>
                                            </a>
                            ...
                            <div class="swiper-slide">
                                <div class="single-product-wrapper style2">
                                    <div class="single-product-item">
                                        <img src="{{asset('public/general/images/products/product-8.gif')}}" alt="...">
                                        <div class="product-overlay style1">
                                            <a href="#" data-toggle="modal" data-target="#exampleModal"> <span class="ti-zoom-in" data-toggle="tooltip" data-placement="right" title="quick view"></span>
                                            </a>
                                            <a href="wishlist.html">
                            ...
                            <div class="swiper-slide">
                                <div class="single-product-wrapper style3">
                                    <div class="single-product-item">
                                        <div class="product-item-img">
                                            <img src="{{asset('public/general/images/products/product-5.jpg')}}" alt="...">
                                        </div>
                                        <div class="product-overlay style1">
                                            <a href="#" data-toggle="modal" data-target="#exampleModal"> <span class="ti-zoom-in" data-toggle="tooltip" data-placement="right" title="quick view"></span>
                                            </a>
                            ...
                            <div class="swiper-slide">
                                <div class="single-product-wrapper style4">
                                    <div class="single-product-item v1">
                                        <img class="product-img" src="{{asset('public/general/images/products/product-9.jpg')}}" alt="...">
                                        <img class="product-img-hover" src="{{asset('public/general/images/products/product-10.jpg')}}" alt="...">
                            ...
                            <div class="swiper-slide">
                                <div class="single-product-wrapper style3">
                                    <div class="single-product-item">
                                        <div class="product-item-img">
                                            <img src="{{asset('public/general/images/products/product-17.jpg')}}" alt="...">
                                        </div>
                                        <div class="product-overlay">
                                            <a href="#" data-toggle="modal" data-target="#exampleModal"> <span class="ti-zoom-in" data-toggle="tooltip" data-placement="right" title="quick view"></span>
                                            </a>
                            ...
                            <div class="swiper-slide">
                                <div class="single-product-wrapper style2">
                                    <div class="single-product-item">
                                        <img src="{{asset('public/general/images/products/product-4.jpg')}}" alt="...">
                                        <div class="product-promo-text style3">
                                            <p>Sold</p>
                                        </div>
                                        <div class="product-overlay">
                            ...
                            <div class="swiper-slide">
                                <div class="single-product-wrapper style2">
                                    <div class="single-product-item">
                                        <img src="{{asset('public/general/images/products/product-15.jpg')}}" alt="...">
                                        <div class="product-promo-text style3">
                                            <p>Sold</p>
                                        </div>
                                        <div class="product-overlay">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="brand-wrapper">
                                    <img src="{{asset('public/general/images/brands/1.png')}}" alt="...">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-wrapper">
                                    <img src="{{asset('public/general/images/brands/2.png')}}" alt="...">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-wrapper">
                                    <img src="{{asset('public/general/images/brands/3.png')}}" alt="...">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-wrapper">
                                    <img src="{{asset('public/general/images/brands/4.png')}}" alt="...">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-wrapper">
                                    <img src="{{asset('public/general/images/brands/5.png')}}" alt="...">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-wrapper">
                                    <img src="{{asset('public/general/images/brands/6.png')}}" alt="...">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-3 col-12">
                    <div class="footer-logo">
                        <a href="#"><img src="{{asset('public/general/images/logo-black.png')}}" alt="..."></a>
                    </div>
